...
var crossPoints = getTangentsFromPoint(circle,point);
// sortが必要
crossPoints.sort((a, b) => (a.x > b.x) ? 1 : (a.x == b.x) ? ((a.y > b.y) ? 1 : -1) : -1);
console.log(crossPoints[0].x.toFixed(8) + " " + crossPoints[0].y.toFixed(8));
console.log(crossPoints[1].x.toFixed(8) + " " + crossPoints[1].y.toFixed(8));
